...
public class StylingOptions extends VerticalLayout {
    ...
    private void applyStyle(String style, Set<Cell> selectedCells, Cell focusedCell, Function<Void, Void> refreshTable) {
        String openTag = "";
        String closeTag = "";
        switch (style) {
            case "bold" -> {
    ...
    public void stylingMenuOptions(MenuItem stylingMenu, Set<Cell> selectedCells, Cell focusedCell, Function<Void, Void> refreshTable) {
    ...
    private Cell getSelectedOrFocusedCell(Set<Cell> selectedCells, Cell focusedCell) {
    ...
    private void applyLink(Set<Cell> selectedCells, Cell focusedCell, Function<Void, Void> refreshTable) {
        ...
        Cell finalFocusedCell = focusedCell;
    ...
    private void insertImage(Set<Cell> selectedCells, Cell focusedCell, Function<Void, Void> refreshTable) {
        focusedCell = getSelectedOrFocusedCell(selectedCells, focusedCell);
